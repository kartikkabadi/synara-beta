...
export const DESKTOP_IPC_CHANNELS = {
  ...
  diagnosticsGetState: "desktop:diagnostics-get-state",
  diagnosticsSetEnabled: "desktop:diagnostics-set-enabled",
  diagnosticsGetSamplePayload: "desktop:diagnostics-get-sample-payload",
  diagnosticsRecordEvent: "desktop:diagnostics-record-event",
  diagnosticsSendTestEvent: "desktop:diagnostics-send-test-event",
